...
public class SpotlightView extends FrameLayout {
     ...
     */
    private TextViewFont subHeadingTv, headingTv;
    ...
    private void addArcAnimation(final Activity activity) {
        ...
        mImageView.setImageResource(com.wooplr.spotlight.R.drawable.ic_spotlight_arc);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            AnimatedVectorDrawable avd = (AnimatedVectorDrawable)
                    ContextCompat.getDrawable(activity, com.wooplr.spotlight.R.drawable.avd_spotlight_arc);
            avd.setColorFilter(porterDuffColorFilter);
            mImageView.setImageDrawable(avd);
            avd.start();
        } else {
            AnimatedVectorDrawableCompat avdc =
                    AnimatedVectorDrawableCompat.create(activity, com.wooplr.spotlight.R.drawable.avd_spotlight_arc);
    ...
    private void addPathAnimation(Activity activity) {
        ...
        //Textviews
        headingTv = new TextViewFont(activity);
        if (mTypeface != null)
        ...
        subHeadingTv = new TextViewFont(activity);
        if (mTypeface != null)
